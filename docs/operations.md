...
`gohist` is centered on observability work in Go. The technical target is: Implement mergeable log-scale histograms and percentile fixtures.
...
The score is deterministic. The current threshold is 152. Risk has a penalty of 4, latency has a penalty of 4, and weight contributes a bonus of 5.
